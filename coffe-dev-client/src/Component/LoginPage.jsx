...
const LoginPage = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Logic: fetch('/api/login', { method: 'POST', ... })
  };
          ...
          <form onSubmit={handleLogin} className="card-body p-10">
            ...
            <div className="form-control w-full mb-2">
              ...
              <label className="label mt-1">
                <a
                  href="#"
                  className="label-text-alt link link-hover text-[#374151]"
                >
                  Forgot password?
                </a>
              </label>
            ...
            <p className="text-center mt-6 text-[#374151] font-medium">
              New here?{" "}
              <a href="/signup" className="link font-bold text-[#331A15]">
                Create an account
              </a>
            </p>
          </form>
