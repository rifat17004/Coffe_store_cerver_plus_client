...
const AddCoffee = () => {
  const handleAddCoffee = (event) => {
    ...
    const CoffeDataobj = Object.fromEntries(formData.entries());

    fetch(`http://localhost:8000/coffes`, {
      method: "POST",
      body: JSON.stringify(CoffeDataobj),
      headers: {
      ...
      .then((res) => res.json())
      .then((data) => {
        if (data.insertedId) Swal.fire("Coffe added to DB");
      });
  };
  ...
  return (
    <div>
      ...
      <div className="bg-[#F4F3F0] border-2 border-white rounded-lg max-w-4xl mx-auto p-10 md:p-20  ">
